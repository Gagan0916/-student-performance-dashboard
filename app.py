...
if st.session_state.analyzed:
    ...
    with st.expander("🔮 Performance Forecast", expanded=True):
        st.write(forecast)
        st.caption(_source_caption(forecast_source))
    with st.expander("🛠️ Subject Improvement Roadmap", expanded=True):
        st.write(roadmap)
        st.caption(_source_caption(roadmap_source))
    with st.expander("🎯 Suggested Goals", expanded=True):
